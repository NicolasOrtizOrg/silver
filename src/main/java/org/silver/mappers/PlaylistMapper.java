...
public class PlaylistMapper {
     ...
     */
    public PlaylistResponseSimpleDTO toDto(PlaylistEntity entity) {
     ...
     */
    public PlaylistEntity toEntity(String playlistName, Long userId) {
     ...
     */
    public PlaylistBookEntity toEntity(Long bookId, Long playlistId) {
